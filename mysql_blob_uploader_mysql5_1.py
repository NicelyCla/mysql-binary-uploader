...
def connect_db(host, user, password, db):
    # On old MySQL servers (5.1) utf8mb4 is not supported.
    # Force the connector to use plain utf8 to avoid SET NAMES 'utf8mb4'.
    return mysql.connector.connect(
        host=host,
        user=user,
        password=password,
        database=db,
        charset="utf8",               # force connector to use utf8 (3-byte) not utf8mb4
